...
WorkflowStepDataAdapter.prototype.getImageByWorkflowStepId = function(workflowStepId){
	 this.getUrl('/{token}/proposal/{proposal}/mx/workflow/step/{0}/image'.format( [workflowStepId.toString()]));
};

WorkflowStepDataAdapter.prototype.getHtmlByWorkflowStepId = function(workflowStepId){
	 this.getUrl('/{token}/proposal/{proposal}/mx/workflow/step/{0}/html'.format( [workflowStepId.toString()]));
};

WorkflowStepDataAdapter.prototype.getResultByWorkflowStepId = function(workflowStepId){
	 this.getUrl('/{token}/proposal/{proposal}/mx/workflow/step/{0}/result'.format( [workflowStepId.toString()]));
};
