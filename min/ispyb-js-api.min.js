...
SessionDataAdapter.prototype.getUrl = DataAdapter.prototype.getUrl, SessionDataAdapter.prototype.getSessions = function() {
    ...
    this.get("/{token}/proposal/{0}/session/{1}/list".format([ a, b ]));
}, SessionDataAdapter.prototype.getSessionsByDate = function(a, b) {
    this.get("/{token}/proposal/session/{0}/{1}/list".format([ a, b ]));
}, SessionDataAdapter.prototype.getSessionsByDateAndBeamline = function(a, b, c) {
    this.get("/{token}/proposal/session/{0}/{1}/list?beamline={2}".format([ a, b, c ]));
