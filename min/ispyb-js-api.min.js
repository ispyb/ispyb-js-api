...
}, WorkflowStepDataAdapter.prototype.getChoochJpegByEnergyScanId = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/energyscan/energyscanId/{0}/jpegchooch".format([ a.toString() ]));
}, WorkflowStepDataAdapter.prototype.getChoochFileByEnergyScanId = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/energyscan/energyscanId/{0}/chooch".format([ a.toString() ]));
}, WorkflowStepDataAdapter.prototype.getScanFileByEnergyScanId = function(a) {
