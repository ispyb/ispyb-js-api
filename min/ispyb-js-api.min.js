...
function MxDataAdapterGroup(a) {
    ...
    this.phasing = new PhasingDataAdapter(a), this.energyscan = new EnergyScanDataAdapter(a), 
    this.xfescan = new XFEScanDataAdapter(a), this.stats = new StatisticsDataAdapter(a), 
    this.dataCollectionGroup = new DataCollectionGroupDataAdapter(a);
}
...
DataAdapter.prototype.getUrl = function(a) {
    ...
    $.ajax({
        ...
        statusCode: {
            401: function() {
                b.onError.notify("401 Unauthorized");
            },
            404: function() {
    ...
    a = this.getUrl(a), $.ajax({
        ...
        statusCode: {
            401: function() {
                c.onError.notify("401 Unauthorized");
            },
            404: function() {
                c.onError.notify("404 : not found");
            },
            415: function() {
                c.onError.notify("415 : type not allowed");
            },
            500: function() {
                c.onError.notify("500 : internal server error");
            }
        },
        url: a,
        data: b,
