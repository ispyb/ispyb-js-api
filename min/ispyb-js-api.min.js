...
}, AutoProcIntegrationDataAdapter.prototype.downloadAttachmentListByautoProcProgramsIdList = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/autoprocintegration/attachment/autoprocprogramid/{0}/download".format([ a.toString() ]));
