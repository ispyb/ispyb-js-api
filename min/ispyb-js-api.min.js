...
StatisticsDataAdapter.prototype.getUrl = DataAdapter.prototype.getUrl, StatisticsDataAdapter.prototype.getStatisticsByDate = function(a, b) {
    return this.getUrl("/{token}/stats/autoprocstatistics/innerShell/{0}/{1}/csv".format([ a, b ]));
