...
function EmDataAdapterGroup(a) {
    this.dataCollection = new EmDataCollectionDataAdapter(a);
}

function EmDataAdapterFactory(a) {
    ...
    this.em = new EmDataAdapterGroup(a);
}
...
function EmDataCollectionDataAdapter(a) {
...
function DataCollectionGroupDataAdapter(a) {
    DataAdapter.call(this, a);
}

function EnergyScanDataAdapter(a) {
    DataAdapter.call(this, a);
}
...
function MxDataAdapterGroup(a) {
    ...
    this.workflow = new WorkflowDataAdapter(a), this.workflowstep = new WorkflowStepDataAdapter(a), 
    this.sample = new SampleDataAdapter(a), this.phasing = new PhasingDataAdapter(a), 
    this.energyscan = new EnergyScanDataAdapter(a), this.xfescan = new XFEScanDataAdapter(a), 
    this.stats = new StatisticsDataAdapter(a), this.dataCollectionGroup = new DataCollectionGroupDataAdapter(a);
}
...
function StatisticsDataAdapter(a) {
    DataAdapter.call(this, a);
}

function WorkflowDataAdapter(a) {
    DataAdapter.call(this, a);
}
...
}, EmDataCollectionDataAdapter.prototype.get = DataAdapter.prototype.get, EmDataCollectionDataAdapter.prototype.post = DataAdapter.prototype.post, 
EmDataCollectionDataAdapter.prototype.getUrl = DataAdapter.prototype.getUrl, EmDataCollectionDataAdapter.prototype.getMoviesDataByDataCollectionId = function(a) {
    return this.get("/{token}/proposal/{proposal}/em/datacollection/{0}/movie/all".format([ a ]));
}, EmDataCollectionDataAdapter.prototype.getMicrographThumbnailURL = function(a, b) {
    return this.getUrl("/{token}/proposal/{proposal}/em/datacollection/{0}/movie/{1}/thumbnail".format([ a, b ]));
}, EmDataCollectionDataAdapter.prototype.getMRCURL = function(a, b) {
    return this.getUrl("/{token}/proposal/{proposal}/em/datacollection/{0}/movie/{1}/mrc".format([ a, b ]));
}, EmDataCollectionDataAdapter.prototype.getMovieMetadataXMLURL = function(a, b) {
    return this.getUrl("/{token}/proposal/{proposal}/em/datacollection/{0}/movie/{1}/metadata/xml".format([ a, b ]));
}, EmDataCollectionDataAdapter.prototype.getMotionCorrectionDriftURL = function(a, b) {
    return this.getUrl("/{token}/proposal/{proposal}/em/datacollection/{0}/movie/{1}/motioncorrection/drift".format([ a, b ]));
}, EmDataCollectionDataAdapter.prototype.getMotionCorrectionThumbnailURL = function(a, b) {
    return this.getUrl("/{token}/proposal/{proposal}/em/datacollection/{0}/movie/{1}/motioncorrection/thumbnail".format([ a, b ]));
}, EmDataCollectionDataAdapter.prototype.geCTFThumbnailURL = function(a, b) {
    return this.getUrl("/{token}/proposal/{proposal}/em/datacollection/{0}/movie/{1}/ctf/thumbnail".format([ a, b ]));
...
AutoProcIntegrationDataAdapter.prototype.getViewByDataCollectionId = function(a) {
    this.get("/{token}/proposal/{proposal}/mx/autoprocintegration/datacollection/{0}/view".format([ a ]));
}, AutoProcIntegrationDataAdapter.prototype.getViewByDataCollectionURL = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/autoprocintegration/datacollection/{0}/view".format([ a ]));
    ...
    return this.getUrl("/{token}/proposal/{proposal}/mx/autoprocintegration/autoprocattachmentid/{0}/download".format([ a.toString() ]));
}, AutoProcIntegrationDataAdapter.prototype.getAttachmentUrl = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/autoprocintegration/autoprocattachmentid/{0}/get".format([ a.toString() ]));
}, AutoProcIntegrationDataAdapter.prototype.getAttachmentListByautoProcProgramsIdList = function(a) {
    return this.get("/{token}/proposal/{proposal}/mx/autoprocintegration/attachment/autoprocprogramid/{0}/list".format([ a.toString() ]));
}, AutoProcIntegrationDataAdapter.prototype.downloadAttachmentListByautoProcProgramsIdList = function(a, b) {
    return b ? this.getUrl("/{token}/proposal/{proposal}/mx/autoprocintegration/attachment/autoprocprogramid/{0}/download?forceFilename={1}".format([ a.toString(), b ])) : this.getUrl("/{token}/proposal/{proposal}/mx/autoprocintegration/attachment/autoprocprogramid/{0}/download".format([ a.toString() ]));
}, AutoProcIntegrationDataAdapter.prototype.getAttachmentListByautoProcProgramsIdListURL = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/autoprocintegration/attachment/autoprocprogramid/{0}/list".format([ a.toString() ]));
}, AutoProcIntegrationDataAdapter.prototype.getPhasingByAutoproccesingIds = function(a) {
    this.get("/{token}/proposal/{proposal}/mx/autoprocintegration/autoprocintegrationid/{0}/phasing".format([ a.toString() ]));
...
}, CrystalDataAdapter.prototype.getGeometryclassBySpacegroup = function(a) {
    this.get("/{token}/proposal/{proposal}/mx/crystal/geometryclass/{0}/list".format([ a ]));
}, CrystalDataAdapter.prototype.save = function(a, b, c, d, e, f, g, h, i, j, k) {
    var l = "/{token}/proposal/{proposal}/mx/crystal/proteinid/{0}/save".format([ a ]);
    this.post(l, {
        proteinId: a,
        crystalId: b,
        name: c,
...
DataCollectionDataAdapter.prototype.getUrl = DataAdapter.prototype.getUrl, DataCollectionDataAdapter.prototype.getBySessionsId = function(a) {
    ...
    this.get("/{token}/proposal/{proposal}/mx/datacollection/{0}/list".format([ a.toString() ]));
}, DataCollectionDataAdapter.prototype.getByAcronymList = function(a) {
    this.get("/{token}/proposal/{proposal}/mx/datacollection/protein_acronym/{0}/list".format([ a.toString() ]));
...
}, DataCollectionDataAdapter.prototype.getQualityIndicatorPlot = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/datacollection/{0}/qualityindicatorplot".format([ a ]));
...
}, DataCollectionDataAdapter.prototype.getDataCollectionsByDataCollectionGroupId = function(a) {
    this.get("/{token}/proposal/{proposal}/mx/datacollection/datacollectiongroupid/{0}/list".format([ a.toString() ]));
}, DataCollectionDataAdapter.prototype.saveComments = function(a, b) {
    var c = "/{token}/proposal/{proposal}/mx/datacollection/{0}/comments/save".format([ a ]);
    this.post(c, {
        comments: b
    });
}, DataCollectionDataAdapter.prototype.getReportURLBySessionId = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/datacollection/session/{0}/report/pdf".format([ a ]));
}, DataCollectionDataAdapter.prototype.getRtfReportURLBySessionId = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/datacollection/session/{0}/report/rtf".format([ a ]));
}, DataCollectionDataAdapter.prototype.getAnalysisReportURLBySessionId = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/datacollection/session/{0}/analysisreport/pdf".format([ a ]));
}, DataCollectionDataAdapter.prototype.getRtfAnalysisReportURLBySessionId = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/datacollection/session/{0}/analysisreport/rtf".format([ a ]));
}, DataCollectionGroupDataAdapter.prototype.get = DataAdapter.prototype.get, DataCollectionGroupDataAdapter.prototype.post = DataAdapter.prototype.post, 
DataCollectionGroupDataAdapter.prototype.getUrl = DataAdapter.prototype.getUrl, 
DataCollectionGroupDataAdapter.prototype.saveComments = function(a, b) {
    var c = "/{token}/proposal/{proposal}/mx/datacollectiongroup/{0}/comments/save".format([ a ]);
    this.post(c, {
        comments: b
    });
}, DataCollectionGroupDataAdapter.prototype.getXtalThumbnail = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/datacollectiongroup/{0}/xtal/thumbnail".format([ a ]));
}, EnergyScanDataAdapter.prototype.get = DataAdapter.prototype.get, EnergyScanDataAdapter.prototype.post = DataAdapter.prototype.post, 
EnergyScanDataAdapter.prototype.getUrl = DataAdapter.prototype.getUrl, EnergyScanDataAdapter.prototype.getEnergyScanListBySessionId = function(a) {
    this.get("/{token}/proposal/{proposal}/mx/energyscan/session/{0}/list".format([ a ]));
}, EnergyScanDataAdapter.prototype.getChoochJpegByEnergyScanId = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/energyscan/energyscanId/{0}/jpegchooch".format([ a.toString() ]));
}, EnergyScanDataAdapter.prototype.getChoochFileByEnergyScanId = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/energyscan/energyscanId/{0}/chooch".format([ a.toString() ]));
}, EnergyScanDataAdapter.prototype.getScanFileByEnergyScanId = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/energyscan/energyscanId/{0}/scanfile".format([ a.toString() ]));
}, PhasingDataAdapter.prototype.get = DataAdapter.prototype.get, PhasingDataAdapter.prototype.post = DataAdapter.prototype.post, 
PhasingDataAdapter.prototype.getUrl = DataAdapter.prototype.getUrl, PhasingDataAdapter.prototype.getPhasingFilesByPhasingProgramAttachmentIdAsImage = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/phasing/phasingprogramattachmentid/{0}/image".format([ a ]));
}, PhasingDataAdapter.prototype.getPhasingViewByAutoProcIntegrationId = function(a) {
    this.get("/{token}/proposal/{proposal}/mx/phasing/autoprocintegrationid/{0}/list".format([ a ]));
}, PhasingDataAdapter.prototype.getPhasingViewByDataCollectionId = function(a) {
    this.get("/{token}/proposal/{proposal}/mx/phasing/datacollectionid/{0}/list".format([ a ]));
}, PhasingDataAdapter.prototype.getPhasingViewByDataCollectionGroupId = function(a) {
    this.get("/{token}/proposal/{proposal}/mx/phasing/datacollectiongroupid/{0}/list".format([ a ]));
}, PhasingDataAdapter.prototype.getPhasingViewBySampleId = function(a) {
    this.get("/{token}/proposal/{proposal}/mx/phasing/sampleid/{0}/list".format([ a ]));
}, PhasingDataAdapter.prototype.getPhasingViewByProteinId = function(a) {
    this.get("/{token}/proposal/{proposal}/mx/phasing/proteinid/{0}/list".format([ a ]));
}, PhasingDataAdapter.prototype.getPhasingViewBySessionId = function(a) {
    this.get("/{token}/proposal/{proposal}/mx/phasing/sessionid/{0}/list".format([ a ]));
}, PhasingDataAdapter.prototype.getPhasingViewByPhasingStepId = function(a) {
    this.get("/{token}/proposal/{proposal}/mx/phasing/phasingstepid/{0}/list".format([ a ]));
}, PhasingDataAdapter.prototype.getDownloadFilesByPhasingStepIdURL = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/phasing/phasingstepid/{0}/download".format([ a ]));
}, PhasingDataAdapter.prototype.getPhasingFilesByPhasingStepId = function(a) {
    this.get("/{token}/proposal/{proposal}/mx/phasing/phasingstepid/{0}/files".format([ a ]));
}, PhasingDataAdapter.prototype.downloadPhasingFilesByPhasingAttachmentId = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/phasing/phasingprogramattachmentid/{0}/download".format([ a ]));
}, PhasingDataAdapter.prototype.getCSVPhasingFilesByPhasingAttachmentIdURL = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/phasing/phasingprogramattachmentid/{0}/csv".format([ a ]));
...
}, SampleDataAdapter.prototype.getSamplesByDewarId = function(a) {
    this.get("/{token}/proposal/{proposal}/mx/sample/dewarid/{0}/list".format([ a ]));
}, SampleDataAdapter.prototype.getSamplesByContainerId = function(a) {
    this.get("/{token}/proposal/{proposal}/mx/sample/containerid/{0}/list".format([ a ]));
}, SampleDataAdapter.prototype.getSamplesBySessionId = function(a) {
    this.get("/{token}/proposal/{proposal}/mx/sample/sessionid/{0}/list".format([ a ]));
}, SampleDataAdapter.prototype.getSamplesByShipmentId = function(a) {
    this.get("/{token}/proposal/{proposal}/mx/sample/shipmentid/{0}/list".format([ a ]));
}, StatisticsDataAdapter.prototype.get = DataAdapter.prototype.get, StatisticsDataAdapter.prototype.post = DataAdapter.prototype.post, 
StatisticsDataAdapter.prototype.getUrl = DataAdapter.prototype.getUrl, StatisticsDataAdapter.prototype.getStatisticsByDate = function(a, b, c) {
    return this.getUrl("/{token}/stats/autoprocstatistics/{0}/{1}/{2}/csv".format([ a, b, c ]));
}, StatisticsDataAdapter.prototype.getStatisticsByDateAndBeamline = function(a, b, c, d) {
    return this.getUrl("/{token}/stats/autoprocstatistics/{0}/{1}/{2}/csv?beamlinenames={3}".format([ a, b, c, d ]));
}, WorkflowDataAdapter.prototype.get = DataAdapter.prototype.get, WorkflowDataAdapter.prototype.post = DataAdapter.prototype.post, 
WorkflowDataAdapter.prototype.getUrl = DataAdapter.prototype.getUrl, WorkflowDataAdapter.prototype.getWorkflowLogUrl = function(a) {
    return this.getUrl("/{token}/mx/workflow/{0}/log".format([ a.toString() ]));
...
WorkflowStepDataAdapter.prototype.getUrl = DataAdapter.prototype.getUrl, WorkflowStepDataAdapter.prototype.getImageByWorkflowStepId = function(a) {
    ...
    this.get("/{token}/proposal/{proposal}/mx/workflow/step/{0}/result".format([ a.toString() ]));
...
}, XFEScanDataAdapter.prototype.get = DataAdapter.prototype.get, XFEScanDataAdapter.prototype.post = DataAdapter.prototype.post, 
XFEScanDataAdapter.prototype.getUrl = DataAdapter.prototype.getUrl, XFEScanDataAdapter.prototype.getXFEScanListBySessionId = function(a) {
    this.get("/{token}/proposal/{proposal}/mx/xrfscan/session/{0}/list".format([ a ]));
}, XFEScanDataAdapter.prototype.getXFEJpegByScanId = function(a) {
    return this.getImage(a, "jpegScanFileFullPath");
}, XFEScanDataAdapter.prototype.getImage = function(a, b) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/xrfscan/xrfscanId/{0}/image/{1}/get".format([ a.toString(), b.toString() ]));
}, XFEScanDataAdapter.prototype.getScanFileScanId = function(a) {
    return this.getFile(a, "scanFileFullPath");
}, XFEScanDataAdapter.prototype.getFile = function(a, b) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/xrfscan/xrfscanId/{0}/file/{1}}/get".format([ a.toString(), b.toString() ]));
}, XFEScanDataAdapter.prototype.getCSV = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/xrfscan/xrfscanId/{0}/csv".format([ a.toString() ]));
...
}, DewarDataAdapter.prototype.getDewarsBySessionId = function(a) {
    this.get("/{token}/proposal/{proposal}/dewar/session/{0}/list".format([ a ]));
}, DewarDataAdapter.prototype.updateSampleLocation = function(a, b, c) {
    var d = "/{token}/proposal/{proposal}/container/{0}/beamline/{1}/samplechangerlocation/update".format([ a, b ]);
    this.post(d, {
        sampleChangerLocation: c.join()
    });
}, DewarDataAdapter.prototype.emptySampleLocation = function(a) {
    var b = "/{token}/proposal/{proposal}/container/{0}/samplechangerlocation/empty".format([ a ]);
    this.post(b);
}, DewarDataAdapter.prototype.exportPDF = function(a, b) {
    return this.getUrl("/{token}/proposal/{proposal}/mx/sample/dewar/{0}/sortView/{1}/list/pdf".format([ a, b ]));
...
}, SessionDataAdapter.prototype.getSessionByProposalSessionId = function(a, b) {
    this.get("/{token}/proposal/{0}/session/sessionId/{1}/list".format([ a, b ]));
}, SessionDataAdapter.prototype.getSessionsByDate = function(a, b) {
    this.get("/{token}/proposal/session/date/{0}/{1}/list".format([ a, b ]));
}, SessionDataAdapter.prototype.getSessionsByDateAndBeamline = function(a, b, c) {
    this.get("/{token}/proposal/session/date/{0}/{1}/list?beamline={2}".format([ a, b, c ]));
}, SessionDataAdapter.prototype.getSessionsByProposalAndDate = function(a, b, c) {
    this.get("/{token}/proposal/{0}/session/date/{1}/{2}/list".format([ c, a, b ]));
}, SessionDataAdapter.prototype.getSessionsByBeamlineOperator = function(a) {
    this.get("/{token}/proposal/session/beamlineoperator/{0}/list".format([ a ]));
}, SessionDataAdapter.prototype.saveComments = function(a, b) {
    var c = "/{token}/proposal/{proposal}/mx/session/{0}/comments/save".format([ a ]);
    this.post(c, {
        comments: b
    });
...
}, ShippingDataAdapter.prototype.addContainer = function(a, b, c, d) {
    this.get("/{token}/proposal/{proposal}/shipping/{0}/dewar/{1}/containerType/{2}/capacity/{3}/container/add".format([ a, b, c, d ]));
}, ShippingDataAdapter.prototype.updateStatus = function(a, b) {
    this.get("/{token}/proposal/{proposal}/shipping/{0}/status/{1}/update".format([ a, b ]));
...
}, ShippingDataAdapter.prototype.getDewarTrackingHistory = function(a) {
    this.get("/{token}/proposal/{proposal}/shipping/{0}/history".format([ a ]));
}, ShippingDataAdapter.prototype.addDewarsToShipment = function(a, b) {
    var c = "/{token}/proposal/{proposal}/shipping/{0}/dewars/add".format([ a ]);
    this.post(c, {
        dewars: JSON.stringify(b)
    });
...
DataCollectionSaxsDataAdapter.prototype.post = DataAdapter.prototype.post, DataCollectionSaxsDataAdapter.prototype.getUrl = DataAdapter.prototype.getUrl, 
DataCollectionSaxsDataAdapter.prototype.getDataCollectionsByMacromoleculeAcronym = function(a) {
    ...
    this.get("/{token}/proposal/{proposal}/saxs/datacollection/dataCollectionId/{0}/bean".format([ a ]));
...
}, DataCollectionSaxsDataAdapter.prototype.getDataCollectionsByExperiment = function(a) {
    this.get("/{token}/proposal/{proposal}/saxs/datacollection/experiment/{0}/list".format([ a ]));
}, DataCollectionSaxsDataAdapter.prototype.getDataCollectionsBySessionId = function(a) {
    this.get("/{token}/proposal/{proposal}/saxs/datacollection/session/{0}/list".format([ a ]));
}, DataCollectionSaxsDataAdapter.prototype.getDataCollectionsByMacromoleculeId = function(a) {
    this.get("/{token}/proposal/{proposal}/saxs/datacollection/macromolecule/{0}/list".format([ a ]));
}, DataCollectionSaxsDataAdapter.prototype.getDataCollectionsById = function(a) {
    this.get("/{token}/proposal/{proposal}/saxs/datacollection/{0}/list".format([ a.toString() ]));
    ...
    if (a.length > 0) for (var b = 0; b < 1; b++) {
...
FrameSaxsDataAdapter.prototype.getUrl = DataAdapter.prototype.getUrl, FrameSaxsDataAdapter.prototype.getFramesByAverageId = function(a) {
    this.get("/{token}/proposal/{proposal}/saxs/frame/average/{0}/bean".format([ a.toString() ]));
}, FrameSaxsDataAdapter.prototype.downloadFramesByAverageIdList = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/saxs/frame/{0}/zip".format([ a.toString() ]));
}, FrameSaxsDataAdapter.prototype.getFramesURL = function(a, b, c, d, e, f, g) {
    null == a && (a = []), null == b && (b = []), null == c && (c = []), null == d && (d = []), 
    null == e && (e = []), null == f && (f = []), null == g && (g = "LOG");
    var h = EXI.credentialManager.getConnections()[0];
    return h.url + "/{0}/proposal/{1}/saxs/frame/datplot?frame={2}&average={3}&subtracted={4}&sampleaverage={5}&bufferaverage={6}&models={7}&operation={8}".format([ h.token, h.user, a.toString(), b.toString(), c.toString(), d.toString(), e.toString(), f.toString(), g ]);
...
}, HPLCSaxsDataAdapter.prototype.getDownloadHDF5URL = function(a) {
    return this.getUrl("/{token}/proposal/{proposal}/saxs/experiment/{0}/hplc/download".format([ a ]));
}, HPLCSaxsDataAdapter.prototype.getDownloadHDF5FramesURL = function(a, b, c) {
    return this.getUrl("/{token}/proposal/{proposal}/saxs/experiment/{0}/hplc/frame/{1}/{2}/zip".format([ a, b, c ]));
...
AuthenticationDataAdapter.prototype.getUrl = DataAdapter.prototype.getUrl, AuthenticationDataAdapter.prototype.authenticate = function(a, b, c) {
    var d = "ESRF";
    c.indexOf("embl-hamburg") != -1 && (d = "EMBL"), c.indexOf("192.109.31.39") != -1 && (d = "EMBL"), 
