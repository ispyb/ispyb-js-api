function DataAdapter(a) {
    this.async = !0, alert("test"), this.url = null, this.token = null, this.proposal = null, 
    this.username = null, this.onSuccess = new Event(this), this.onError = new Event(this), 
    null != a && (null != a.username && (this.username = a.username), null != a.async && (this.async = a.async), 
    null != a.onSuccess && this.onSuccess.attach(a.onSuccess), null != a.onError && this.onError.attach(a.onError), 
    null != a.url && (this.url = a.url), null != a.token && (this.token = a.token), 
    null != a.proposal && (this.proposal = a.proposal));
}
...
DataCollectionDataAdapter.prototype.getUrl = DataAdapter.prototype.getUrl, DataCollectionDataAdapter.prototype.getBySessionsId = function(a) {
    ...
    this.get("/{token}/proposal/{proposal}/mx/datacollection/acronyms/{0}/list".format([ a.toString() ]));
