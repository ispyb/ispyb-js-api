...
DataCollectionDataAdapter.prototype.getUrl = DataAdapter.prototype.getUrl, DataCollectionDataAdapter.prototype.getBySessionsId = function(a) {
...
}, DataCollectionDataAdapter.prototype.test = function(a) {
    var b = "/{token}/proposal/{proposal}/mx/save", c = {
        spaceGroupNumber: 1,
        ...
        recordTimeStamp: "Mar 2, 2010 3:21:03 PM"
    }, {
        fileType: "Logfile",
        fileName: "test33.mtz",
        filePath: "testtesttest",
    ...
    this.post(b, {
        phasingStep: JSON.stringify(e),
        spaceGroup: JSON.stringify(c),
        run: JSON.stringify(d),
        attachments: JSON.stringify(f)
    });
