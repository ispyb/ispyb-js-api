...
<head>
  <meta charset="utf-8">
  <title>Plato - node_modules/grunt-legacy-log-utils/node_modules/lodash/dist/lodash.compat.min.js</title>
...
<div class="jumbotron">
  <div class="container">
    <h1>node_modules/grunt-legacy-log-utils/node_modules/lodash/dist/lodash.compat.min.js</h1>
  </div>
</div>
...
!on||on.global!==on&amp;&amp;on.window!==on||(nn=on);var un=g();&quot;function&quot;==typeof define&amp;&amp;&quot;object&quot;==typeof define.amd&amp;&amp;define.amd?(nn._=un,define(function(){return un})):rn&amp;&amp;en?tn?(en.exports=un)._=un:rn._=un:nn._=un}).call(this);</textarea>
  </div>
</div>
