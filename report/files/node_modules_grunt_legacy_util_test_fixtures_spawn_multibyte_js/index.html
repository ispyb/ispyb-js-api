...
<head>
  <meta charset="utf-8">
  <title>Plato - node_modules/grunt-legacy-util/test/fixtures/spawn-multibyte.js</title>
...
<div class="jumbotron">
  <div class="container">
    <h1>node_modules/grunt-legacy-util/test/fixtures/spawn-multibyte.js</h1>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <textarea id="file-source" class="col-md-12">// This is a test fixture for a case where spawn receives incomplete
...
process.stderr.write(fullOutput.slice(4));</textarea>
  </div>
</div>
